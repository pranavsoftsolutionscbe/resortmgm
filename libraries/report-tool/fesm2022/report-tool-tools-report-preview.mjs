...
class ReportPreviewModule {
    ...
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "16.2.1", ngImport: i0, type: ReportPreviewModule, declarations: [ReportPreviewComponent], imports: [CommonModule], exports: [ReportPreviewComponent] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "16.2.1", ngImport: i0, type: ReportPreviewModule, providers: [DatePipe], imports: [CommonModule] }); }
}
...
//# sourceMappingURL=report-tool-tools-report-preview.mjs.map
